...
def test_pass_case(parser_url, api_client, unique_top_module):
    """PASS 主路径"""
...
def test_retry_semantic(parser_url, api_client, unique_top_module):
...
def test_retry_compile(parser_url, api_client, unique_top_module):
...
def test_infra_error_no_retry(parser_url, api_client, unique_top_module):
...
def test_port_direction_retry(parser_url, api_client, unique_top_module):
...
def test_port_width_retry(parser_url, api_client, unique_top_module):
